(function (global, flashy) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = flashy() : typeof define === 'function' && define.amd ? define(flashy) : global.flashy = flashy() }(this, function () {
    "use strict"; if (typeof window.jQuery === 'undefined' && window.$ === 'undefined') throw new Error('flashy required Jquery')
    ...
    Flashy.Timer = function () {
        if (!Flashy.OPTIONS_COPY.stop) { AnimatedProgress = setTimeout(function () { Flashy.Out(); ApplyCallBack() }, Flashy.OPTIONS_COPY.timeout) }
        Flashy.OPTIONS_REPLACE = {}
    }
    ...
    Flashy.AnimatedClass = { Animated: 'animated', AnimatedBounceRight: 'bounceOutRight', AnimatedInRight: 'bounceInRight' }; function StringifyOptions() {
        Flashy.Hide()
    ...
    Flashy.OptionPreliminary = function () {
        for (var id in Flashy.OPTIONS) { if (typeof Flashy.OPTIONS_COPY[id] == "undefined") { Flashy.OPTIONS_COPY[id] = Flashy.OPTIONS[id] } }
    ...
    var Plugin = function (title, params, $callBack) {
        if (typeof title == "undefined" && typeof params == "undefined" && typeof $callBack == "undefined") { throw new Error("you must specify at least a parameter") }
